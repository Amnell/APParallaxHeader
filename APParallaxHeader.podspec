Pod::Spec.new do |s|
  ...
  s.description = 'This category makes it super easy to add a parallax header ' \ 
                  'view to your table views. Other alternatives relies on ' \
                  'subclassing of UITableViewController or UITableView.' \
                  'APParallaxHeader uses the Objective-C runtime instead to ' \
                  'add the following method to UIScrollView'
